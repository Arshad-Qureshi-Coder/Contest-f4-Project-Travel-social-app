...
import BackArrowIcon from "../images/Vector 12.png";
    ...
    <div>
      ...
      <div className="post-detail">
        ...
        <div className="post-content">
          <button
            className={showUserInfo ? "inactiveBtn" : "activeBtn"}
            onClick={() => setShowUserInfo(false)}
          >
            Detail
          </button>
          <button
            className={showUserInfo ? "activeBtn" : "inactiveBtn"}
      ...
      <div className="side-page-heading">More Posts</div>
      <Card posts={posts} />
    </div>
  );
};
